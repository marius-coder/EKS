...
class Scraper():
    def __init__(self):
        ...
        self.eMobilitätGebäude = {
            ...
            "GebäudezuEMobilität [kWh/m²]" : 0,  #Ohne Verluste / Verluste rausgerechnet
            "EMobilitätzuGebäude [kWh/m²]" : 0,  #Ohne Verluste / Verluste rausgerechnet
            }
        ...
        self.primärenergie = {
            "PE_OhnePV [kWh/m²]" : 0,
            "PE_MitPV [kWh/m²]" : 0,
            "PE_MitEmobilität [kWh/m²]" : 0,
            }
        self.CO2Emissionen = {
            "CO2_OhnePV [kg/m²]" : 0,
            "CO2_MitPV [kg/m²]" : 0,
            "CO2_MitEmobilität [kg/m²]" : 0,
            }
