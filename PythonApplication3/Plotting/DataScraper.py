...
class DataScraper():
    ...
    def Init_eMobility(self):
        ...
        self.demand = []			#Liste in der der Bedarf von Außerhalb gespeichert wird
        ...
        self.generation = []		#Liste in der die von außerhalb produzierte Leistung gespeichert wird
